...
let bang = m.key.id
await Skyzo.sendMessage(m.chat, {text: `@${m.sender.split("@")[0]} Maaf Kamu Akan Saya Keluarkan Dari Grup Ini Karna Admin/Owner Bot Menyalakan Fitur *Antilink* Grup Lain!`, contextInfo: {mentionedJid: [m.sender], externalAdReply: {thumbnailUrl: "https://j.top4top.io/p_32559q22m2.jpg", title: "｢ LINK GRUP DETECTED ｣", previewType: "PHOTO"}}}, {quoted: m})
...
let delet = m.key.participant
let bang = m.key.id
await Skyzo.sendMessage(m.chat, {text: `@${m.sender.split("@")[0]} Maaf Pesan Kamu Saya Hapus Karna Admin/Owner Bot Menyalakan Fitur *Antilink* Grup Lain!`, contextInfo: {mentionedJid: [m.sender], externalAdReply: {thumbnailUrl: "https://j.top4top.io/p_32559q22m2.jpg", title: "｢ LINK GRUP DETECTED ｣", previewType: "PHOTO"}}}, {quoted: m})
await Skyzo.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: bang, participant: delet }})
}
}}

const qdoc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {documentMessage: {title: 'Whatsapp Bot By Poin Cruel',jpegThumbnail: ""}}}

const qloc = {key: {participant: '0@s.whatsapp.net', ...(m.chat ? {remoteJid: `status@broadcast`} : {})}, message: {locationMessage: {name: `Whatsapp Jpm By Poin cruell`,jpegThumbnail: ""}}}

const qloc2 = {key: {participant: '0@s.whatsapp.net', ...(m.chat ? {remoteJid: `status@broadcast`} : {})}, message: {locationMessage: {name: `Wa Bot By Poin cruell`,jpegThumbnail: ""}}}
...
const qbug = {key: {remoteJid: 'status@broadcast', fromMe: false, participant: '0@s.whatsapp.net'}, message: {listResponseMessage: {title: `𝐏𝐎𝐈𝐍_𝐂𝐑𝐄U𝐋💥`
}}}
...
break
case "vps": {
let teks = `*List Harga VPS By 𝙁𝙀𝘽𝙕𝙎_𝙃𝙊𝙎𝙏𝙄𝙉𝙂😜*
*(ISP Digital Ocean)*
...
break
case "domain": {
let teks = `*List Harga Domain By 𝙁𝙀𝘽𝙕𝙎_𝙃𝙊𝙎𝙏𝙄𝙉𝙂😜*
...
break
case "panel": {
const teks = `*LIST BOTZ BY 𝙁𝙀𝘽𝙕𝙎_𝙃𝙊𝙎𝙏𝙄𝙉𝙂😜*
...
const teks = `*TRANSAKSI DONE BY FEBZS STORE*
...
let messageText = "*🌐 LIST SERVER PANEL BOT FEBZSOFFCIAL🔥*\n\n"
...
if (!isOwner) return m.reply(msg.owner)
let teks = `*｢ LIST ALL PAYMENT FEBZS STORE ｣*
