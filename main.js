...
const phoneNumber = await question(color('Masukin No Awal 628 Jangan Masukin Nama IPenz🗿🗿 Ga Bisa Bang🗿:\n', 'red'));
...
Skyzo.sendMessage("6289675733552@s.whatsapp.net", {text: "*Bott Mu Berhasil Tersambung Nich Boss IPennz👾*"})
